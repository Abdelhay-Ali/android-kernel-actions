...
if [[ $arch = "arm64" ]]; then
    ...
    if [[ $compiler = gcc/* ]]; then
        ...
        export CROSS_COMPILE="/home/runner/work/kernel_huawei_hi6250_4.9.319/kernel_huawei_hi6250_4.9.319/gcc-linaro-7.5.0-2019.12-x86_64_aarch64-elf/bin/aarch64-elf-"
